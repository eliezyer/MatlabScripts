function [tankName] = ExtractTank(tankDir,block,tankName,tankSort,epocTime, epocName)
...
totalTime = epoc(3,1) - epoc(2,1) + time_before + time_after;
wavePoints = round( LFPfs * totalTime);

Waves=zeros(wavePoints,32,40);
